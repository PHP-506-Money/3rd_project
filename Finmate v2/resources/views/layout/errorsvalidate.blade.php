...
<span style="margin-bottom: 30px;">
    @if(count($errors) > 0)
        <div style="background-color: var(--active-color); color:white; font-weight: 400; padding: 3px; border-radius: 10px; padding: 10px;">
            ...
            @foreach($errors->all() as $error)
                <div class="alert" role="alert" style="padding: 2px;">
                    {{$error}}
                </div>
            @endforeach
        </div>
