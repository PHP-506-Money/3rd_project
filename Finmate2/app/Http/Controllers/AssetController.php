...
class AssetController extends Controller
{
    ...
    //     $api_key = "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";

    //     $url = "https://api.openai.com/v1/completions";

    //     // "What is the capital of France?"
    //     $prompt = filter_var($req->prompt, FILTER_SANITIZE_STRING);;
    ...
    //     return view('assets', ['assets'=>$assets])->with('response',$response);
